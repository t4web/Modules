...
class UpgradeControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreation()
    {
        ...
        $this->assertTrue($this->controllerManager->has('Modules\Controller\Console\Upgrade'));

        $controller = $this->controllerManager->get('Modules\Controller\Console\Upgrade');

        $this->assertInstanceOf('Modules\Controller\Console\UpgradeController', $controller);
